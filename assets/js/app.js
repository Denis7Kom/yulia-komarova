...
const translations = {
  ru: {
    ...
    signatureOneText: 'Она держит процесс без лишнего шума: задачи, люди, сроки и backstage остаются в рабочем ритме.',
    ...
    cardConcertsText: 'Её деятельность связана с организацией концертных событий, гастрольной логикой, работой с площадкой, командой и backstage-процессами.',
    ...
    turnkeyText: 'В работе Юлии событие рассматривается как цельная система: идея, подготовка, команда, backstage, публика и финальное впечатление.',
    ...
    timelineTwo: 'Работа с событиями, командой, площадкой и backstage-процессами.',
